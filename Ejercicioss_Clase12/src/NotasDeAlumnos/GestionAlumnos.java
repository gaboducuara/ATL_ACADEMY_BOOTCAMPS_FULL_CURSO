...
public class GestionAlumnos {
    ...
    private List<AtributosAlumnos> alumnos = new ArrayList<>();
    ...
    public void registrarAlumnos() {
        ...
        while (bandera) {
            ...
            AtributosAlumnos alumno = new AtributosAlumnos();
    ...
    private void ingresarNotas(AtributosAlumnos alumno) {
    ...
    private void mostrarAlumnos() {
        ...
        for (AtributosAlumnos alumno : alumnos) {
    ...
    private String mostrarNotas(AtributosAlumnos alumno) {
